...
const EditJobPage = ({ updateJobData }) => {
  const navigate = useNavigate();
  const job = useLoaderData();

  // Job Details
  const [jobType, setJobType] = useState(job.type); // important to set the job type initially because if not set and the user uses the default value then the value will be ''
