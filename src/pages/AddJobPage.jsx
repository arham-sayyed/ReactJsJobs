...
const AddJobPage = ({ addJobData }) => {
  const navigate = useNavigate();

  // Job Details
  const [jobType, setJobType] = useState("Full-Time"); // important to set the job type initially because if not set and the user uses the default value then the value will be ''
